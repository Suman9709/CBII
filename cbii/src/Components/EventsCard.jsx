...
const EventsCard = ({ img, eventName, description, buttonName }) => {
  return (
    <div className="w-full max-w-md border border-gray-300 rounded-2xl shadow-xl overflow-hidden flex flex-col h-96 transition-transform duration-300 hover:shadow-2xl hover:-translate-y-1">
