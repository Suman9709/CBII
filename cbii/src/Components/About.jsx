            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-4 lg:px-8 py-12">
                ...
                <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 mb-16">
                    ...
                    <div className="lg:w-1/2">
                        <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
                            <p className="text-lg text-gray-700 leading-relaxed mb-4">
                                Shivalik College, Dehradun proudly launched the Center of Business Incubation and
                                Innovations (CBII) in 2022, a pioneering initiative to nurture aspiring entrepreneurs.
                                It is recognized and registered with MSME, Government of India.
                            </p>
                            <p className="text-lg text-gray-700 leading-relaxed mb-4">
                                The CBII is running with a vision to cultivate an environment conducive to young
                                entrepreneurs, emphasizing innovation, sustainability, and social relevance. It is
                                designed to support the creation, incubation, and successful operation of innovative
                                businesses that prioritize societal and environmental impact.
                            </p>
                            <p className="text-lg text-gray-700 leading-relaxed">
                                Based on its work and progress, the Uttarakhand Startup Council, Directorate of
                                Industries, Government of Uttarakhand has recognized the successful journey of CBII
                                in 2023 and sanctioned financial support to expand its wings further.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="lg:w-1/2 flex flex-col gap-16">
                        ...
                        {/* Stats Cards - Now positioned below image in right column */}
                    ...
                    <div className="lg:w-1/2 flex flex-col">
                        <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 flex-grow">
                            <p className="text-lg text-gray-700 leading-relaxed mb-2">
                                Shivalik College has tied up with IIT Roorkee in year 2022, and launched iHUB Shivalik,
                                a Spoke of iHUB DivyaSampark, IIT Roorkee.
                            </p>
                            <p className="text-lg text-gray-700 leading-relaxed mb-2">
                                The college is working in mission mode to provide business development assistance,
                                by ensuring the availability of infrastructure, mentorship, and training support and
                                above all, the entrepreneurial culture among the students in the campus.
                            </p>
                            <p className="text-lg text-gray-700 leading-relaxed">
                                This strategic partnership brings the expertise and resources of one of India's premier
                                institutions to foster innovation and entrepreneurship at Shivalik College.
                            </p>
                        </div>
                        ...
                        {/* <div className="mt-8 grid grid-cols-2 gap-4">
                            ...
                            <div className="bg-red-50 p-4 rounded-lg text-center hover:bg-red-100 transition-colors">
                                <p className="text-3xl font-bold text-[#841B31]">IIT</p>
                            ...
                            <div className="flex flex-col md:flex-row h-full">
                                ...
                                <div className="md:w-2/3 p-6 flex flex-col justify-center">
                                    ...
                                    <p className="text-gray-700">
                                        ...
                                        validating our commitment to fostering entrepreneurship and supporting innovative
                                        business ideas with national recognition.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 overflow-hidden">
                            <div className="flex flex-col md:flex-row h-full">
                                ...
                                <div className="md:w-2/3 p-6 flex flex-col justify-center">
                                    ...
                                    <p className="text-gray-700">
                                        Our collaboration with IIT Roorkee through iHUB DivyaSampark brings premier
                                        technical expertise and research capabilities to our entrepreneurial ecosystem,
                                        elevating the quality of innovation at Shivalik College.
                                    </p>
                                </div>
                            </div>
                        </div>
